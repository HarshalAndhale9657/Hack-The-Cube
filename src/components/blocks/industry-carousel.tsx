...
const tracks: TrackCard[] = [
  {
    ...
    description: "LLMs, multi-agent frameworks, neural search, and computer vision applications.",
  ...
  },
  {
    ...
    number: "02",
    title: "FinTech & Web3",
    description: "Decentralized protocols, high-frequency fraud detection, and digital financial tools.",
    image: "/images/placeholder.png",
  },
  {
    id: "track-3",
    ...
    description: "Zero-trust networks, automated threat remediation, and cloud native dev platforms.",
    image: "/images/placeholder.png",
  },
  {
    id: "track-4",
    ...
    description: "Diagnostic intelligence, electronic medical records, and telemedicine infrastructure.",
    image: "/images/placeholder.png",
  },
  {
    id: "track-5",
    ...
    description: "Smart grid analytics, carbon monitoring, and renewable energy optimization systems.",
    image: "/images/placeholder.png",
  },
];
